...
$(function(){var e;try{$(window).on("load",function(){e=new google.maps.Map(document.getElementById("map"),{center:{lat:55.760186,lng:37.618711},zoom:13,styles:[{featureType:"administrative",elementType:"all",stylers:[{visibility:"simplified"}]},{featureType:"administrative.province",elementType:"all",stylers:[{visibility:"off"}]},{featureType:"administrative.locality",elementType:"all",stylers:[{visibility:"simplified"}]},{featureType:"administrative.neighborhood",elementType:"all",stylers:[{visibility:"off"}]},{featureType:"landscape",elementType:"all",stylers:[{visibility:"on"}]},{featureType:"landscape.man_made",elementType:"all",stylers:[{visibility:"on"}]},{featureType:"landscape.man_made",elementType:"geometry.fill",stylers:[{lightness:"-2"},{hue:"#ffcc00"},{saturation:"0"}]},{featureType:"landscape.natural",elementType:"geometry.fill",stylers:[{saturation:"9"},{lightness:"-5"}]},{featureType:"poi",elementType:"all",stylers:[{visibility:"simplified"}]},{featureType:"poi",elementType:"labels.text",stylers:[{hue:"#0024ff"}]},{featureType:"poi",elementType:"labels.text.stroke",stylers:[{visibility:"on"},{lightness:"-100"}]},{featureType:"poi",elementType:"labels.icon",stylers:[{visibility:"on"}]},{featureType:"poi.attraction",elementType:"all",stylers:[{visibility:"off"}]},{featureType:"poi.business",elementType:"labels",stylers:[{visibility:"simplified"}]},{featureType:"poi.business",elementType:"labels.text.fill",stylers:[{color:"#111e6c"}]},{featureType:"poi.business",elementType:"labels.text.stroke",stylers:[{visibility:"on"},{lightness:"-100"}]},{featureType:"poi.business",elementType:"labels.icon",stylers:[{hue:"#0024ff"},{saturation:"-62"},{visibility:"simplified"}]},{featureType:"poi.government",elementType:"all",stylers:[{visibility:"simplified"}]},{featureType:"poi.medical",elementType:"all",stylers:[{visibility:"simplified"}]},{featureType:"poi.park",elementType:"geometry.fill",stylers:[{saturation:"6"},{lightness:"-23"}]},{featureType:"road",elementType:"all",stylers:[{visibility:"on"}]},{featureType:"road",elementType:"labels",stylers:[{visibility:"off"}]},{featureType:"transit",elementType:"all",stylers:[{visibility:"on"}]},{featureType:"transit",elementType:"labels",stylers:[{visibility:"off"}]},{featureType:"water",elementType:"all",stylers:[{visibility:"on"}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#12608d"}]},{featureType:"water",elementType:"geometry.fill",stylers:[{lightness:"0"},{color:"#111e6c"}]},{featureType:"water",elementType:"labels.text.fill",stylers:[{visibility:"off"}]},{featureType:"water",elementType:"labels.text.stroke",stylers:[{visibility:"off"}]}]}),new google.maps.Marker({position:{lat:55.762186,lng:37.625711},map:e,title:"Наш маркер: Большой театр",icon:"../img/map-marker.svg"})})}catch(e){}$(".hard-table .tr-default").click(function(e){$(this).next(".tr-content").toggle()}),$(".progress-bar > span").each(function(){var e=$(this).children("span"),t=e.attr("statusText");$(this).closest(".progress-bar").hasClass("green")?($(this).data("origWidth",$(this).width()).width(0).animate({width:$(this).data("origWidth")},1200),setTimeout(function(){e.text(t)},1200)):e.text(t)}),$(".exchange .column .subblock-content .btns .item").click(function(e){$(this).closest(".btns").find(".is-selected").removeClass("is-selected"),$(this).addClass("is-selected")}),$(".inner .navbars .item__nav a").click(function(e){e.preventDefault(),$(".inner .list-numeric.drop .item__head").removeClass("opened"),$(".inner .list-numeric.drop .item__content").slideUp();var t=$(this).attr("href");$("html, body").animate({scrollTop:$(t).offset().top-$(window).height()/2},1e3),$(t).find(".item__content").slideDown(),$(t).find(".item__head").addClass("opened")}),$(".inner .list-numeric.drop .item__content").hide(),$(".inner .list-numeric.drop .item__head.opened").closest(".item").find(".item__content").slideDown(),$(".inner .list-numeric.drop .item__head").click(function(e){$(this).toggleClass("opened").closest(".item").find(".item__content").slideToggle()}),$(".js-view-other").click(function(e){e.preventDefault();var t=$(this),i=t.find(".item").attr("text"),s=t.find(".item").attr("replaceText");t.closest(".currencies").hasClass("hidden-opened")?(t.closest(".currencies").removeClass("hidden-opened"),t.find(".item span").text(i)):(t.closest(".currencies").addClass("hidden-opened"),t.find(".item span").text(s))}),$(".js-select-currencies .item:not(.js-view-other .item)").click(function(e){e.preventDefault(),$(this).closest(".column").find(".currencies .item").removeClass("is-selected"),$(this).addClass("is-selected")}),$(".js-dropdown-link").click(function(e){e.preventDefault(),$(this).closest(".dropdown").toggleClass("_opened")}),$(".header .nav-menu>li .dropdown-link").click(function(e){e.preventDefault(),$(this).closest(".transform-to-mobile").toggleClass("sub-opened")}),$(document).click(function(e){$(e.target).closest(".dropdown").length||($(".dropdown").removeClass("_opened"),e.stopPropagation())}),$(".rippler").rippler({effectClass:"rippler-effect",effectSize:0,addElement:"div",duration:400}),$(".hamburger").click(function(e){e.preventDefault(),$("body").hasClass("menu-mobile__opened")&&$(".transform-to-mobile").removeClass("sub-opened"),$(this).toggleClass("is-active"),$("body").toggleClass("menu-mobile__opened")}),$(".popup-with-zoom-anim").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-zoom-in",callbacks:{open:function(){$(".header, .page__footer, .page__content").addClass("effects-blur"),$.magnificPopup.instance.close=function(){$(".header, .page__footer, .page__content").removeClass("effects-blur"),$.magnificPopup.proto.close.call(this)}}}}),Modernizr.svg||$("img[src*='svg']").attr("src",function(){return $(this).attr("src").replace(".svg",".png")}),$("img.img-svg").each(function(){var e=$(this),t=e.attr("id"),i=e.attr("class"),s=e.attr("src");$.get(s,function(s){var l=$(s).find("svg");void 0!==t&&(l=l.attr("id",t)),void 0!==i&&(l=l.attr("class",i+" replaced-svg")),!(l=l.removeAttr("xmlns:a")).attr("viewBox")&&l.attr("height")&&l.attr("width")&&l.attr("viewBox","0 0 "+l.attr("height")+" "+l.attr("width")),e.replaceWith(l)},"xml")})});